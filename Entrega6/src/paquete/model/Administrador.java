...
public class Administrador extends Persona{
	...
	public void agregarCurso(String Sigla,String Nombre,String Profesor,String Sala, String Año, String Semestre, String Seccion, String Creditos, String Departamento, String Requisitos, String Horario, String Id){
		String nuevoCurso = Sigla+"-"+Nombre+"-"+Profesor+"-"+Sala+"-"+Año+","+Semestre+"-"+Seccion+"-"+Creditos+"-"+Departamento+"-"+Requisitos+"-"+Horario+"-"+Id;
	...
	public void escribirNoticia(String noticia){
		MainApp.texto.escribirDesdeCero("noticias.txt", noticia);
	}
	...
	public void fijarNotaExcelencia(String max){
		t.escribirDesdeCero("notaExcelencia.txt", max);
	}
