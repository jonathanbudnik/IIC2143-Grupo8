...
public class Texto {
	...
	public String retornarLinea2Palabras(String nombreArchivo, String palabraBuscada1, String palabraBuscada2){//NUEVO
		...
		try{
			...
			while(linea!=null){
				...
				else if (linea.toLowerCase().contains(palabraBuscada1.toLowerCase()) && linea.toLowerCase().contains(palabraBuscada2.toLowerCase())){
					retorno += linea ;
					retorno += "\n";
				}
			}
